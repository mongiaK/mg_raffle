...
typedef int (*libbpf_print_fn_t)(enum libbpf_print_level level, const char *,
                                 va_list ap);
...
bpf_object__open_file(const char *path,
...
LIBBPF_API struct bpf_program *
bpf_object__next_program(const struct bpf_object *obj,
...
LIBBPF_API struct bpf_program *
bpf_object__prev_program(const struct bpf_object *obj,
                         struct bpf_program *prog);
 ...
 * different.
 */
LIBBPF_API const struct bpf_insn *
bpf_program__insns(const struct bpf_program *prog);
 ...
 */
LIBBPF_API struct bpf_link *
bpf_program__attach_usdt(const struct bpf_program *prog, pid_t pid,
                         const char *binary_path, const char *usdt_provider,
...
LIBBPF_API struct bpf_link *
bpf_program__attach_trace_opts(const struct bpf_program *prog,
...
LIBBPF_API struct bpf_link *
bpf_program__attach_freplace(const struct bpf_program *prog, int target_fd,
...
LIBBPF_API int bpf_map__set_initial_value(struct bpf_map *map, const void *data,
                                          size_t size);
 ...
 */
LIBBPF_API int bpf_map__lookup_elem(const struct bpf_map *map, const void *key,
 ...
 */
LIBBPF_API int bpf_map__update_elem(const struct bpf_map *map, const void *key,
 ...
 */
LIBBPF_API int bpf_map__delete_elem(const struct bpf_map *map, const void *key,
...
perf_buffer__new(int map_fd, size_t page_cnt, perf_buffer_sample_fn sample_cb,
...
LIBBPF_API const struct bpf_line_info *
bpf_prog_linfo__lfind(const struct bpf_prog_linfo *prog_linfo, __u32 insn_off,
                      __u32 nr_skip);
...
typedef int (*libbpf_prog_attach_fn_t)(const struct bpf_program *prog,
                                       long cookie, struct bpf_link **link);
 ...
 */
LIBBPF_API int
libbpf_register_prog_handler(const char *sec, enum bpf_prog_type prog_type,
