...
class String {
   ...
   public:
    String(int typ = 1) : a(NULL), size(0), type(typ) { std::cout << "constructor" << std::endl; }

    String(const String& str, int typ = 1) : type(typ) { std::cout << "param constructor" << std::endl; }
...
//        std::cout << "exp == var, var = " << var.load() << ", exp = " << exp_var
//                  << std::endl;
//    } else {
//        std::cout << "exp != var, var = " << var.load() << ", exp = " << exp_var
//                  << std::endl;
