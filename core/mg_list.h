...
static mg_inline mg_void_t init_list(mg_list* l) {
    l->_next = l;
    l->_prev = l;
}

static mg_inline mg_void_t insert_list_front(mg_list* e, mg_list* l) {
    e->_next = l;
    e->_prev = l->_prev;
    l->_prev->_next = e;
    l->_prev = e;
...
static mg_inline mg_void_t insert_list_end(mg_list* e, mg_list* l) {
    e->_next = l->_next;
    e->_prev = l;
    l->_next->_prev = e;
    l->_next = e;
...
static mg_inline mg_void_t remove_list_node(mg_list* e, mg_bool_t cleanup) {
...
static mg_inline mg_list* list_head(mg_list* l) { return l->_next; }

static mg_inline mg_list* list_tail(mg_list* l) { return l->_prev; }
